...
**Surface:** <autoship-build surface if applicable: oracle | backend | frontend. Omit for extract.>
**Timestamp:** <ISO-8601, e.g., 2026-04-24T14:22:00Z>
**Filed by:** <role name — e.g., ui-walker, stage2-executor, reconciler>
...
artifact excerpts side by side. This is evidence, not a paraphrase. The controller
...
shape is probably wrong"), name the pattern. The controller uses the pattern to
...
marked as guess. Not load-bearing — the controller may ignore this entirely —
