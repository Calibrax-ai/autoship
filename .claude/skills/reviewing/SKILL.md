...
Reviewing is the shared discipline for autoship evaluator agents. A reviewer judges an artifact it did not author, using a domain rubric, and returns a binary verdict with evidence-backed objections.
...
- The controller needs a judgment gate before spending compute, changing code, creating issues, or opening a PR.
