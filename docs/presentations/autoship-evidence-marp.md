...
paginate: true
size: 16:9
title: autoship — Evidence from 9 probes
---
...
<span class="eyebrow">Autoship · Evidence · 2026-04-17</span>

# Demo to production,<br/>without rewriting from scratch.

<p class="lede">Nine probes of empirical evidence that <em>extracting the spec</em> from a working demo is the hard part — and it's tractable.</p>
...
# Nine probes. Convergence.

| Probe | What it tested | Outcome |
|---|---|---|
| 0 – 1.5 | Ingest pipeline | Spec extraction works end-to-end |
| 2 | First full build from spec | <span class="pull">4.5K lines, 45 endpoints, 11 pages — zero human help</span> |
| 2.5 | Stronger oracle + vertical slices | API layer excellent; UI still a shell |
| 2.6 | Playwright journey tests | Orphan pages in 6 of 11 screens |
| 2.7 | Slice-by-journey | Orphans fixed; <em>dialog theater</em> surfaces |
| 2.8 | Seeded data + screenshot-as-contract | **Live app renders real data, 1:1 with reference** |
| 2.9 | Author/judge separation | In flight |

<p class="dim" style="margin-top: 16px; font-size: 18px;">
...
### Orphan pages <span class="dim">(2.6)</span>
...
### Dialog theater <span class="dim">(2.7)</span>
...
### Empty-tenant blind spot <span class="dim">(2.7)</span>
...
<p class="mono" style="color:var(--teal-300); font-size:13px; letter-spacing:0.15em; margin:0 0 8px 0;">NOW</p>

### Probe 2.9 · <span class="dim">plan-reviewer</span>

A dedicated fresh-context reviewer, armed with a calibration set of past mistakes.

Tests whether same-model (Claude-on-Claude) separation catches the self-eval failures every prior gate absorbed.

<p class="dim" style="font-size:16px; margin-top:10px;">Inflection point for the generator-evaluator thesis.</p>

</div>

<div>

<p class="mono" style="color:var(--teal-300); font-size:13px; letter-spacing:0.15em; margin:0 0 8px 0;">NEAR-TERM · TWO TRACKS</p>

### App shell scaffold
Pre-built monorepo: shared components, schema helpers, seed bootstrap, locked file layout. Probes start at the slice-loop, not from empty.

### Multi-model reviewer
Codex alongside <span class="mono">plan-reviewer</span>. Different training distribution, different blind spots. Complementary to 2.9, not corrective.
...
- **A second prototype to probe against.** Pick one from the team — ideally with a real customer story behind it.
- **30 minutes with a PM** who's lived a demo→production rewrite. Where did *your* spec leak?
- **Honest pushback on the thesis.** If "extracting the spec is the hard part" is wrong, the sooner we know, the better.
...
<div class="quote">
When the tool learns the system by breaking it, each failure is evidence — not a setback.
</div>
<div class="quote-attr">— operating principle</div>
...
<p class="lede" style="margin-top: 28px;">
<span class="mono">shyang@calibrax</span> &nbsp;·&nbsp; <span class="dim">autoship · v0.2 · 2026-04-17</span>
</p>
