...
Stable operating knowledge lives in the controller agent file (`.claude/agents/controller.md`). Repo policy lives in `.autoship/standards.yaml`. This file is only the run contract for one audit loop.
