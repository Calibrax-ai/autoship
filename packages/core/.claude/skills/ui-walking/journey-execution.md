...
- Interpret intent beyond what the oracle stated. If the oracle says "expect URL = /dashboard" and the URL is /dashboard?welcome=1, that is a fact for the controller to interpret, not for the walker to soft-pass.
