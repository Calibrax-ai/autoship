# design.md — Worked Example (PostHog-inspired)

This is a complete filled-in example of the design.md format. It serves as a **depth floor** — your output for any prototype should match this level of detail across all 9 sections. Values here are from a PostHog-inspired design; your values will differ based on the prototype you're analyzing.
